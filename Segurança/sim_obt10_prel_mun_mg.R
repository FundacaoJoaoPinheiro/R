...
#' SIM's ICD-10 preliminary database much in the same way that is done
#' by the online portal. The argument options refer to
#' data focused on Minas Gerais cities.
#'
#' 
#' @usage sim_obt10_prel_mun_mg(linha = "Município", coluna = "Não ativa",
...
#' sim_obt10_prel_mun_mg(grande_grupo_cid10 = "V01-V99 Acidentes de transporte", sexo="Masc")
#' }
#'
...
sim_obt10_prel_mun_mg <- function(linha = "Munic\u00edpio", coluna = "N\u00e3o ativa", conteudo = 2, periodo = "last", municipio = "all",
  ...
  page <- xml2::read_html("http://tabnet.datasus.gov.br/cgi/deftohtm.exe?sim/cnv/pext10mg.def")
  ...
  site <- httr::POST(url = "http://tabnet.datasus.gov.br/cgi/tabcgi.exe?sim/cnv/pext10mg.def",
                     body = form_data)
